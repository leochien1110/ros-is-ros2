"""rosnode command - thin shim over 'ros2 node'."""
...
def main(args: list[str] | None = None) -> int:
    """Main entry point for rosnode command."""
    return main_generic("rosnode", args)


def main_with_completion():
    """Main entry point with argparse completion support."""
    return generic_main_with_completion("rosnode")
