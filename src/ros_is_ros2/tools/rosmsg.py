"""rosmsg command - thin shim over 'ros2 interface'."""
...
def main(args: list[str] | None = None) -> int:
    """Main entry point for rosmsg command."""
    return main_generic("rosmsg", args)


def main_with_completion():
    """Main entry point with argparse completion support."""
    return generic_main_with_completion("rosmsg")
